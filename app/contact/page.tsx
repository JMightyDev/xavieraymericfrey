							...
							<div className="grid md:grid-cols-2 gap-12 items-start">
								...
								<div className="bg-snow-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-morning-mist/30 animate-on-scroll">
									...
									<div className="space-y-6">
										...
										<div className="flex items-start space-x-4">
											<div className="w-12 h-12 bg-gray-800/20 rounded-full flex items-center justify-center flex-shrink-0">
												<svg
									...
									<div className="mt-8 p-4 bg-gradient-to-r from-red-600/10 to-gray-800/10 rounded-lg border border-red-600/20">
