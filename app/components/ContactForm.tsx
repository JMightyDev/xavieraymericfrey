			...
			<form onSubmit={handleSubmit} className="space-y-6">
				...
				<div>
					...
					<textarea
						...
						className="w-full px-4 py-3 border border-morning-mist/40 rounded-lg bg-snow-white/50 focus:outline-none focus:border-red-600 transition-all duration-200 hover:shadow-md resize-none"></textarea>
				</div>
