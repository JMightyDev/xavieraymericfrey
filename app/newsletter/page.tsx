							...
							<div className="bg-snow-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-morning-mist/30 animate-on-scroll">
								...
								<div className="mb-6">
									<div className="grid md:grid-cols-3 gap-6 text-center">
										<div className="p-4">
											<div className="w-12 h-12 bg-sunset-orange/20 rounded-full flex items-center justify-center mx-auto mb-3">
												<svg
										...
										<div className="p-4">
											<div className="w-12 h-12 bg-lake-turquoise/20 rounded-full flex items-center justify-center mx-auto mb-3">
												<svg
